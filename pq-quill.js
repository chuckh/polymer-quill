...
var Selection = function () {
  ...
  _createClass(Selection, [{
    ...
    value: function getNativeSelection() {
      ...
      // console.log('typeof:',typeof document.getSelection,this.rootNode);
      return ( this.rootNode && typeof this.rootNode.getSelection === 'function') ? this.rootNode.getSelection() : document.getSelection();
    }  
  }, {
    key: 'getRange',
    ...
    key: 'hasFocus',
    value: function hasFocus() {
      var activeElement = this.rootNode && this.rootNode.activeElement || document.activeElement;
